...
public abstract class Magican extends Actor {
    ...
    public void step(LinkedList<Actor> units){
        ...
        if(enemyIndex != 999 & friendIndex != 999){
            ...
            System.out.println(magRank+" "+magName+" забрал "+magForce+" здоровья у "+enemyRank+" "+enemyName+", оставив ему "+enemyHp+"% жизни\n");
            ...
            System.out.println(magRank+" "+magName+" отдал "+magForce+" здоровья "+friendRank+" "+friendName+", вылечив его до "+friendHp+"% жизни\n");
        }
        return;
    }
