...
//                Control.console.append(java.time.LocalDateTime.now().format(java.time.format.DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss ")));
                System.out.println(myRank+" "+myName+" идет на восток\n");
...
//                Control.console.append(java.time.LocalDateTime.now().format(java.time.format.DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss ")));
                    System.out.println(myRank+" "+myName+" идет на север\n");
       //             System.out.println(this.getX(),this.getY(), "");
...
//                Control.console.append(java.time.LocalDateTime.now().format(java.time.format.DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss ")));
                    System.out.println(myRank+" "+myName+" идет на запад\n");
               //     System.out.println(this.getX(),this.getY(), "");
                this.setX(this.getX()-1);}}
            if(min.equals(y)){
                if (units.get(friendIndex).getY()==this.getY()-1){min = X;} // если на пути друг, то обходим
   ...
   //             Control.console.append(java.time.LocalDateTime.now().format(java.time.format.DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss ")));
                    System.out.println(myRank+" "+myName+" идет на юг\n");
...
//                    Control.console.append(java.time.LocalDateTime.now().format(java.time.format.DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss ")));
                    System.out.println(myRank+" "+myName+" зарубил "+enemyRank+" "+enemyName+", забрав броню имеет "+damage[0]+"\n");
...
//            Control.console.append(java.time.LocalDateTime.now().format(java.time.format.DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss ")));
            System.out.println(myRank+" "+myName+" не нашел противника"+"\n");
            return;
        }
    }
